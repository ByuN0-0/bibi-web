  ...
  return (
    <div className="mx-auto max-w-[1500px]">
      <div className="mb-8">
        ...
        <p className="eyebrow mt-5">Correction</p>
        <h1 className="mt-3 text-3xl font-bold tracking-[-0.03em]">경기 결과 수정</h1>
        <p className="mt-3 text-sm leading-6 text-[var(--muted)]">블루·레드 양 팀의 점수판을 한 화면에서 수정할 수 있으며, 팀 합계와 Data Dragon 에셋을 저장 전에 다시 검증합니다.</p>
      </div>
